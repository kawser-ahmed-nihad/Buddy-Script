    ...
    >
      ...
      <div className="relative z-10 max-w-2xl w-full">
        ...
        <p className="text-white/90 mb-8">
          Search discussions by tags and explore insightful conversations.
        </p>
        ...
        <div className="flex flex-col md:flex-row items-center justify-center gap-4">
          ...
          <button className="bg-white text-[#3F51B5] px-6 py-4 rounded-full flex items-center gap-2 shadow-md hover:bg-gray-100">
            <FaSearch />
